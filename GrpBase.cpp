...
#ifdef DIRECTX9_EX
IDirect3D9Ex*			CGraphicBase::ms_lpd3d = nullptr;
IDirect3DDevice9Ex*		CGraphicBase::ms_lpd3dDevice = nullptr;
#else
...
#ifdef DIRECTX9_EX
D3DDISPLAYMODEEX		CGraphicBase::displayMode = {};
D3DDISPLAYMODEEX*		CGraphicBase::pDisplayMode = nullptr;
#endif
...
bool					CGraphicBase::ms_bEnableGlobalAntialiasing = false; // a-a
...
bool CGraphicBase::SetPDTStream(SPDTVertexRaw* pSrcVertices, UINT uVtxCount)
{
	...
	IDirect3DVertexBuffer9* plpd3dFillRectVB = nullptr;
