...
class CGraphicBase
{
	...
	public:
		...
		static int						ms_fShadowIntensity; // xdd
	...
	protected:
		...
		static HDC						ms_hDC;
#ifdef DIRECTX9_EX
		static IDirect3D9Ex*			ms_lpd3d;
		static IDirect3DDevice9Ex*		ms_lpd3dDevice;
#else
...
#ifdef DIRECTX9_EX
		static D3DDISPLAYMODEEX			displayMode;
		static D3DDISPLAYMODEEX*		pDisplayMode;
#endif
		...
		*/
		...
		static bool						ms_bEnableGlobalAntialiasing; // a-a
